...
from user_settings import MPIIGAZE_PATH
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default=MPIIGAZE_PATH)
    parser.add_argument('--outdir', type=str, default=os.path.join(DATA_PATH, "mpiigaze_processed_by_me"))
